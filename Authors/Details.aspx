<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Details.aspx.cs" Inherits="Authors_Details" %>
...
<body>
    <div class="container">
        <div class="col-lg-offset-3 col-lg-6">
            <h1 class="text-center">Edit Author # Details<asp:Literal ID="ltID" runat="server" /></h1>
            <div class="well">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-4 col-lg-8">
                            <asp:Button ID="btnUpdate" runat="server" 
                                CssClass="btn btn-success btn-lg" Text="Update" OnClick="btnUpdate_Click"/>
                            <a href="Default.aspx" class="btn btn-default">Back</a>
                        </div>
                    </div>
                </form>
            </div>
